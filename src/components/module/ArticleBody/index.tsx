      ...
      { fetchedArticle &&
            <div>
              <div className={'flex rounded-sm h-4 w-4 mr-2'} >
                {fetchedArticle.parents && fetchedArticle.parents?.at(-1).attachment!=''?
                  <Image alt="logo" src={'https://i.simpalsmedia.com/point.md/logo/'+fetchedArticle.parents?.at(-1).attachment} width={16} height={16} className="w-full h-full"></Image>
                  :
